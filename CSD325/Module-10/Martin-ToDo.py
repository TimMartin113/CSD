...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.scrollbar = tk.Scrollbar(
            self.tasks_canvas, orient="vertical", 
        ...
        todo1 = tk.Label(
            self.tasks_frame, 
            text="Type your task here and press Enter to add it to the list."
            "\nRight click on a task to remove it.", 
